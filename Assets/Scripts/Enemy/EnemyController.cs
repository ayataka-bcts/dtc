...
{
    [Header("Player")]
    [Tooltip("ï‡Ç≠ÇÕÇ‚Ç≥Ç™ïœÇÌÇËÇ‹Ç∑(m/s)")]
    [Label("ï‡Ç≠ÇÕÇ‚Ç≥")]
    public float MoveSpeed = 2.0f;

    [Tooltip("ëñÇÈë¨Ç≥Ç™ïœÇÌÇËÇ‹Ç∑(m/s)")]
    [Label("ëñÇÈÇÕÇ‚Ç≥")]
    public float SprintSpeed = 5.335f;

    [Tooltip("å¸Ç´ÇïœÇ¶ÇÈÇ∆Ç´ÇÃëÅÇ≥")]
    [Label("å¸Ç´ÇÃÇÕÇ‚Ç≥")]
    [Range(0.0f, 0.3f)]
    public float RotationSmoothTime = 0.12f;

    [Tooltip("ÇÕÇ‚Ç≠Ç»ÇËÇ‚Ç∑Ç≥Ç∆Ç®ÇªÇ≠Ç»ÇËÇ‚Ç∑Ç≥")]
    [Label("ÇÕÇ‚Ç≥ÇÃïœÇÌÇËï˚")]
